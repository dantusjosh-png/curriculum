...
(function () {
  ...
  var REPO = 'dantusjosh-png/curriculum';
  ...
  function initGroupSubmit(node) {
    ...
    node.appendChild(el('div', {
      'class': 'cc-meta',
      text: 'Submitting opens a pre-filled GitHub issue — confirm it there. The professor grades it, comments feedback, and logs the verdict on this page.'
    }));
  ...
  function initDashboard(node) {
    ...
    if (!node.children.length) {
      ...
      node.appendChild(el('p', { 'class': 'cc-meta', text: 'This panel reflects activity in this browser. The permanent record lives in the repo: graded submissions are logged on each module page.' }));
    }
  }
